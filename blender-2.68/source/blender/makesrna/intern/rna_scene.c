...
EnumPropertyItem tool_shelf_items[] = { 
	{SCE_MESH, "MESH", 0, "Mesh", ""}, 
	{SCE_CURVE, "CURVE", 0, "Curve", ""}, 
	{SCE_SURF, "SURFACE", 0, "Surface", ""}, 
	{SCE_METABALL, "METABALL", 0, "Metaball", ""}, 
    {SCE_TEXT, "TEXT", 0, "Text", ""}, 
	{SCE_ARMA, "ARMATURE", 0, "Armature", ""}, 
	{SCE_LATTI, "LATTICE", 0, "Lattice", ""}, 
	{SCE_EMPTY, "EMPTY", 0, "Empty", ""}, 
    {SCE_SPEAKER, "SPEAKER", 0, "Speaker", ""}, 
	{SCE_CAMERA, "CAMERA", 0, "Camera", ""}, 
	{SCE_LAMP, "LAMP", 0, "Lamp", ""}, 
	{SCE_FORCE, "FORCE", 0, "Force Field", ""}, 
	{SCE_CUSTOM, "CUSTOM", 0, "Custom Tool", ""}, 
    {SCE_CUSTOM_DELETE, "CUSTOM_DELETE", 0, "Custom Clear", ""},
	{0, NULL, 0, NULL, NULL} 
};
...
static void rna_def_tool_settings(BlenderRNA  *brna)
{
	...
	prop = RNA_def_property(srna, "tool_shelf", PROP_ENUM, PROP_NONE); 
	RNA_def_property_enum_sdna(prop, NULL, "toolshelf.tool"); 
	RNA_def_property_enum_items(prop, tool_shelf_items); 
	RNA_def_property_ui_text(prop, "Tool Shelf", "Toolshelf"); 
