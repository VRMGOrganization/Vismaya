...
static void rna_def_userdef_theme_space_layer(BlenderRNA *brna)
{
	StructRNA *srna;
//	PropertyRNA *prop;
	...
	srna = RNA_def_struct(brna, "ThemeLayersEditor", NULL);
	RNA_def_struct_sdna(srna, "ThemeSpace");
	RNA_def_struct_clear_flag(srna, STRUCT_UNDO);
	RNA_def_struct_ui_text(srna, "Theme Layer", "Theme settings for the Layermanagement");
...
static void rna_def_userdef_themes(BlenderRNA *brna)
{
	...
	static EnumPropertyItem active_theme_area[] = {
		...
		{21, "LAYER_EDITOR", ICON_LAYER_MANAGE, "Layer Editor", ""}, 
		{0, NULL, 0, NULL, NULL}
	};
	...
	prop = RNA_def_property(srna, "layer_editor", PROP_POINTER, PROP_NONE);
	RNA_def_property_flag(prop, PROP_NEVER_NULL);
	RNA_def_property_pointer_sdna(prop, NULL, "tlayer");
	RNA_def_property_struct_type(prop, "ThemeLayersEditor");
	RNA_def_property_ui_text(prop, "Layermanagement", "");
...
static void rna_def_userdef_dothemes(BlenderRNA *brna)
{
	...
	rna_def_userdef_theme_space_layer(brna);
