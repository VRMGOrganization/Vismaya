...
typedef struct Toolshelf { 
	float col[3]; 
	char tool, pad1, pad2, pad3; 
} Toolshelf;
/* *************************************************************** */
/* Tool Settings */
...
/* toosettings->toolshelf */ 

#define SCE_MESH		      0 
#define SCE_CURVE	          1 
#define SCE_SURF		      2 
#define SCE_METABALL	      3 
#define SCE_TEXT		      4 
#define SCE_ARMA		      5 
#define SCE_LATTI	          6 
#define SCE_EMPTY	          7 
#define SCE_SPEAKER           8 
#define SCE_CAMERA	          9 
#define SCE_LAMP		     10 
#define SCE_FORCE		     11
#define SCE_CUSTOM	         12 
#define SCE_CUSTOM_DELETE    13
