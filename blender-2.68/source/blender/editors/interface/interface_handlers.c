...
/*		return 0;*/
	...
	{   /* Docs */
		...
		if (but->rnapoin.data && but->rnaprop) {
            ...
            WM_operator_properties_create(&ptr_props, "WM_OT_custom_menu");
			RNA_string_set(&ptr_props, "doc_id", buf);
			uiItemFullO(layout, "WM_OT_custom_menu", CTX_IFACE_(BLF_I18NCONTEXT_OPERATOR_DEFAULT, "Add To Custom "),
			            ICON_NONE, ptr_props.data, WM_OP_EXEC_DEFAULT, 0);
           
            WM_operator_properties_create(&ptr_props, "WM_OT_custom_remove_menu");
			RNA_string_set(&ptr_props, "doc_id", buf);
			uiItemFullO(layout, "WM_OT_custom_remove_menu", CTX_IFACE_(BLF_I18NCONTEXT_OPERATOR_DEFAULT, "Remove From Custom "),
			            ICON_NONE, ptr_props.data, WM_OP_EXEC_DEFAULT, 0);
