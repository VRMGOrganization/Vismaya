...
#define ICON_DEFAULT_HEIGHT 19
#define ICON_DEFAULT_WIDTH  19

#define ICON_DEFAULT_HEIGHT_SCALE ((int)(UI_UNIT_Y * 1.3f))
#define ICON_DEFAULT_WIDTH_SCALE  ((int)(UI_UNIT_X * 1.3f))
